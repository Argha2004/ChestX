 ...
 */
fun Modifier.pressScale(pressedScale: Float = 0.94f): Modifier = composed {
    var pressed by remember { mutableStateOf(false) }
    val scale by animateFloatAsState(
        targetValue = if (pressed) pressedScale else 1f,
        // Bouncy, playful press (Tolan-style): squashes on press and springs back with a
        // subtle overshoot on release, while the palette stays clean/medical.
